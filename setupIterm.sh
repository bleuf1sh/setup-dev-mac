...
open "$LOCAL_SETUP_DEV_MAC_GIT_REPO/terminal-profiles/Peppermint.terminal"

# Set iTerm Preferences
cp "$LOCAL_SETUP_DEV_MAC_GIT_REPO/terminal-profiles/com.googlecode.iterm2.plist" ~/Library/Preferences
